...
# Create a style for the text widgets
style = ttk.Style()
...
# Create a label for the old format input text area
...
# Create a text area for old format input
...
# Create a button to clear old format input
...
# Create a button to convert old format to new format
...
# Create a label for the new format output text area
...
# Create a text area for new format output
...
# Create a button to clear new format output
...
# Create a button to load the old-to-new groups mapping
...
# Create a label for the input text area
...
# Create a button to get the new groups
...
# Create a label for the output text area
...
# Create a frame for output buttons
...
# Create a button to clear all fields
